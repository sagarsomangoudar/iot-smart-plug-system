...
public class GradeP2 {
	...
	public static void main(String[] args) throws Exception {
		SimConfig config = new SimConfig(
			8080, Arrays.asList("xxxx", "yyyy", "zzzz.789"), "tcp://127.0.0.1", "iot_sim", "iot_ece448");
						/*  For Newer Gradle version, we passed argument values for mqttBroker, mqttClientId, mqttTopicPrefix 
